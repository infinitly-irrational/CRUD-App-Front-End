		...
		<div className="student">
			{/* An example of how each student will look can be changed*/}
						<table>
							...
							<td>
							<button className='a' onClick={console.log("Hello World")}>Remove Student</button>
							</td>
							</tr>
						...
						props.allStudents.map((element, index) => {
							return (
									<tr>
										...
										<td>
											<button className={element.id} onclick= {deleteStudentThunk(element.id)}>Remove Student</button>
										</td>
									</tr>
								);
							})
